...
sessionStorage.setItem("user2","Vamshi");
sessionStorage.setItem("user3","Pavithra");
sessionStorage.setItem("user4","Sanjay");
sessionStorage.setItem("user5","Rishi");
sessionStorage.setItem("user6","Anjali");
